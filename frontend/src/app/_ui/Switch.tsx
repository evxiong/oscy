        ...
        <>
          <div
            className={merge(
              ...
              "group-data-[focus-visible]/switch:ring-ring group-data-[focus-visible]/switch:ring-2 group-data-[focus-visible]/switch:ring-offset-2",
              "bg-border group-data-[selected]/switch:bg-gold",
            )}
          >
            <div
              className={merge(
                "bg-background pointer-events-none block size-4 rounded-full shadow-lg transition-transform",
